...
void device_info(struct xclmgmt_dev *lro, struct xclmgmt_ioc_info *obj)
{
	...
	obj->mig_calibration[1] = (val & BIT(1)) ? true : false;
	obj->mig_calibration[2] = (val & BIT(2)) ? true : false;
	obj->mig_calibration[3] = (val & BIT(3)) ? true : false;
